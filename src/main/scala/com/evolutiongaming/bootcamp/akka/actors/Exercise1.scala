...
object Exercise1 extends App {
   ...
   */
  final class BatcherActor(batchSize: Int, sinkRef: ActorRef) extends Actor {
    import Protocol._
  ...
  val batcherRef = system.actorOf(Props(new BatcherActor(batchSize = 2, sinkRef = workerRef)), "batcher")
